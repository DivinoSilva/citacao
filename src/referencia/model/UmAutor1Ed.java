...
/**
 * Classe criada para as Citações com 1 autor, sendo primeira Edição
 * @author Divino Silva
 * @since Classe criada em 15/06/2016
 */
public class UmAutor1Ed extends JFrame{
    ...
    public void editarLabel() {
        ...
        l7.setBounds(300, 50, 550, 100);
    }

    /*Função que seta os texto dos LABEL's*/
    public void poeTexto() {
        l1.setText("PEDROSA, I..");
        l2.setText("Da cor à cor inexistente.");
        l3.setText("Rio de Janeiro:");
        l4.setText("Atlas,");
        l5.setText("1995.");
    }
    ...
    public void verificarGanhou() {
        if (bateu(l1, p1) && bateu(l2, p2) && bateu(l3, p3) && bateu(l4, p4) && bateu(l5, p5) ) {
